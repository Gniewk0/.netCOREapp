...
using ProjektZaliczeniowyCore.Data;
using ProjektZaliczeniowyCore.Models;

namespace ProjektZaliczeniowyCore.Controllers
{
    public class EventsController : Controller
    {
        private readonly ProjektZaliczeniowyCoreContext _context;

        public EventsController(ProjektZaliczeniowyCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Date,Type,Description")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Date,Type,Description")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
